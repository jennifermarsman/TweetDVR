...
{
    public class SqlAzureSampleBolt : ISCPBolt
    {
        ...
        public SqlAzureSampleBolt(Context context, Dictionary<string, Object> parms)
        {
            ...
            //TODO: Add/Remove fields based on columns in your table - based on SCPHost.exe.config entries
        ...
        public static SqlAzureSampleBolt Get(Context context, Dictionary<string, Object> parms)
        {
            return new SqlAzureSampleBolt(context, parms);
        }
